import type { FrameData } from '../tgfx/src/wechat/array-buffer-image'
import { ArrayBufferImage } from '../tgfx/src/wechat/array-buffer-image'
import { MP4_CACHE_PATH } from './constant'
import { removeFile, touchDirectory, writeFile } from './file-utils'

import { wx } from './interfaces'
import type { FrameDataOptions, VideoDecoder } from './interfaces'
