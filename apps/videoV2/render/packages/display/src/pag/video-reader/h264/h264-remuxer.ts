...
import { ErrorCode } from './error-map'
import { Log } from './log'

const concatUint8Arrays = (arrays: Array<Uint8Array>) => {
  let totalLength = 0
...
export class H264Remuxer {
  ...
  public static remux(frames: H264Frame[], headers: Uint8Array[], width:number, height:number, frameRate:any, ptsList:any) {
