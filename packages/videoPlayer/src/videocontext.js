...
let lutFilter = {
  ...
  properties: {
    ...
    // 选择 LUT strip 中的第几行（0-based）
    lutIndex: { type: "uniform", value: 0 },
    // LUT strip 总行数，与图片匹配
    lutRows: { type: "uniform", value: 16 },
    // LUT 应用强度 0.0 ~ 1.0
    lutStrength: { type: "uniform", value: 1 },
    // 锐化强度 0.0 ~ 5.0
...
let DEFINITIONS = {
  ...
  FLASH_BLACK: flashBlack,
  FLASH_WHITE: flashWhite,
  DREAMY_ZOOM: dreamyZoom,
  ZOOM: zoom,
  GLITCH: glitch,
  PERLIN: perlin,
  BURN: burn,
